...
from SpikingNN.model_zoo.parnet import *
from SpikingNN.datasets.datasets import *
from SpikingNN.common import AverageMeter, accuracy
...
parser.add_argument('--node', type=str, default='PLIFNode')
...
parser.add_argument('--base_dir', type=str, default='/data/floyed/bio_snn/ckpt')
...
if args.dataset == 'mnist':
    train_loader, test_loader, _, _ = get_mnist_data(args.batch_size)
elif args.dataset == 'fashion':
    train_loader, test_loader, _, _ = get_fashion_data(args.batch_size)
elif args.dataset == 'cifar10':
    train_loader, test_loader, _, _ = get_cifar10_data(args.batch_size)
elif args.dataset == 'cifar100':
    train_loader, test_loader, _, _ = get_cifar100_data(args.batch_size)
    num_classes = 100
elif args.dataset == 'imnet':
    train_loader, test_loader, _, _ = get_imnet_data(args.batch_size)
    num_classes = 1000
